...
@section('title', 'Sustainability | Bjarke Ingels Group')
...
<div style="border-top:1px solid #e8e8e8;">
    ...
    <div class="sust-section" style="padding-top:40px;border-bottom:1px solid #e8e8e8;">
        <div class="sust-section-label">{{ $p[1] }}</div>
        <div style="font-size:11px;color:#999;letter-spacing:.06em;text-transform:uppercase;margin-bottom:14px;">{{ $p[0] }} · {{ $p[3] }}</div>
        <p>{{ $p[2] }}</p>
    </div>
    @endforeach
</div>
