...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — BIG Admin</title>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-brand">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-name">B<span>I</span>G</a>
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="<?php echo e(route('admin.careers.index')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.careers.*') ? 'active' : ''); ?>">
...
<div class="main-wrapper">
    ...
    <div class="topbar">
        ...
        <div class="topbar-actions">
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="btn-icon" title="View Site">
                <i class="bi bi-eye"></i>
            </a>
            <a href="<?php echo e(route('admin.settings.index')); ?>" class="btn-icon" title="Settings">
...
<?php /**PATH C:\Users\Md Zainal Abedin\Desktop\big-architecture\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>