                ...
                <div class="dropdown">
                    ...
                    <ul tabindex="0"
                        ...
                        <li>
                            ...
                            <ul class="p-2">
                                <li><a class="text-red-700" href="<?php echo e(route('projects.index')); ?>">Master Plan</a></li>
                        ...
                        <li><a href="<?php echo e(route('people')); ?>">Team</a></li>
                        <li><a href="<?php echo e(route('about')); ?>">Contact</a></li>
                    </ul>
                </div>
                <a class="text-xl" href="<?php echo e(route('home')); ?>"><img src="https://i.ibb.co/hxY9HBFW/logo-6-removebg-preview.png"
                        alt=""></a>
            </div>
...
</html><?php /**PATH C:\Users\Md Zainal Abedin\Desktop\big-architecture\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>